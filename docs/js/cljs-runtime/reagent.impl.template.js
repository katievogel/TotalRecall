...
var G__41749 = o;
goog.object.set(G__41749,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41769__delegate = function (args){
...
while (G__41770__i < G__41770__a.length) {G__41770__a[G__41770__i] = arguments[G__41770__i + 0]; ++G__41770__i;}
  args = new cljs.core.IndexedSeq(G__41770__a,0,null);
} 
return G__41769__delegate.call(this,args);};
G__41769.cljs$lang$maxFixedArity = 0;
G__41769.cljs$lang$applyTo = (function (arglist__41771){
var args = cljs.core.seq(arglist__41771);
return G__41769__delegate(args);
});
...
var G__41752 = o;
goog.object.set(G__41752,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__41777__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__41777 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__41778__i = 0, G__41778__a = new Array(arguments.length -  0);
while (G__41778__i < G__41778__a.length) {G__41778__a[G__41778__i] = arguments[G__41778__i + 0]; ++G__41778__i;}
  args = new cljs.core.IndexedSeq(G__41778__a,0,null);
} 
return G__41777__delegate.call(this,args);};
G__41777.cljs$lang$maxFixedArity = 0;
G__41777.cljs$lang$applyTo = (function (arglist__41779){
var args = cljs.core.seq(arglist__41779);
return G__41777__delegate(args);
});
...
var G__41753 = props;
var G__41753__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41753,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41753);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41753__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41754 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41754,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41754;
}
})(),id_class);
...
var G__41755 = (cljs.core.count(argv) - first_child);
switch (G__41755) {
case (0):
...
var vec__41756 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(2),null);
...
var temp__5739__auto___41797 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___41797 == null)){
} else {
var key_41798 = temp__5739__auto___41797;
(jsprops.key = key_41798);
}
...
var temp__5739__auto___41799 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___41799 == null)){
} else {
var key_41800 = temp__5739__auto___41799;
(jsprops.key = key_41800);
}
...
var temp__5739__auto___41801 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___41801 == null)){
} else {
var key_41802 = temp__5739__auto___41801;
(jsprops.key = key_41802);
}
...
var temp__5739__auto___41803 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___41803 == null)){
} else {
var key_41804 = temp__5739__auto___41803;
(jsprops.key = key_41804);
}
...
var temp__5739__auto___41805 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___41805 == null)){
} else {
var key_41806 = temp__5739__auto___41805;
(jsprops.key = key_41806);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41759_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41759_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41760 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41760,(1),null);
...
break;
default:
var G__41810 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__41811 = compiler;
v = G__41810;
compiler = G__41811;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41766 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41766 = (function (opts,id,fn_to_element,meta41767){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41766.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41768,meta41767__$1){
var self__ = this;
var _41768__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41766(self__.opts,self__.id,self__.fn_to_element,meta41767__$1));
}));

(reagent.impl.template.t_reagent$impl$template41766.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41768){
var self__ = this;
var _41768__$1 = this;
return self__.meta41767;
}));

(reagent.impl.template.t_reagent$impl$template41766.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41766.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41766.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41766.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41766.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta41767","meta41767",237666965,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41766.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41766.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41766");

(reagent.impl.template.t_reagent$impl$template41766.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template41766");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41766.
 */
reagent.impl.template.__GT_t_reagent$impl$template41766 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41766(opts__$1,id__$1,fn_to_element__$1,meta41767){
return (new reagent.impl.template.t_reagent$impl$template41766(opts__$1,id__$1,fn_to_element__$1,meta41767));
});

}

return (new reagent.impl.template.t_reagent$impl$template41766(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
