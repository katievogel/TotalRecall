...
var G__41696 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41696;
continue;
} else {
return ch;
...
var vec__41679 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41679,(0),null);
return (match === s);
});
...
var i__4737__auto___41724 = (0);
while(true){
if((i__4737__auto___41724 < len__4736__auto___41721)){
args__4742__auto__.push((arguments[i__4737__auto___41724]));

var G__41725 = (i__4737__auto___41724 + (1));
i__4737__auto___41724 = G__41725;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41686){
...
return (function() { 
var G__41726__delegate = function (rdr,_){
...
var G__41726 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41728__i = 0, G__41728__a = new Array(arguments.length -  1);
while (G__41728__i < G__41728__a.length) {G__41728__a[G__41728__i] = arguments[G__41728__i + 1]; ++G__41728__i;}
  _ = new cljs.core.IndexedSeq(G__41728__a,0,null);
} 
return G__41726__delegate.call(this,rdr,_);};
G__41726.cljs$lang$maxFixedArity = 1;
G__41726.cljs$lang$applyTo = (function (arglist__41729){
var rdr = cljs.core.first(arglist__41729);
var _ = cljs.core.rest(arglist__41729);
return G__41726__delegate(rdr,_);
});
