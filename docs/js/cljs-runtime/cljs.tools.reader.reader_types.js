...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41462 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41462(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41469 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41469(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41478 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41478(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41480 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41480(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41483 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41483(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41501 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41501(reader);
}
});
...
var G__41654 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41655 = s.append(c);
c = G__41654;
s = G__41655;
continue;
}
