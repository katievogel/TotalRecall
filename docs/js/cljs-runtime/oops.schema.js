...
var G__51964 = cljs.core.first(element_str);
switch (G__51964) {
case "?":
arr.push((1));
...
var G__51993 = cljs.core.next(items);
items = G__51993;
continue;
} else {
return null;
...
var G__51994 = cljs.core.next(items);
items = G__51994;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__51978 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__51978) : is_valid_QMARK_.call(null,G__51978));
})())){
var G__52006 = cljs.core.next(cljs.core.next(items));
items = G__52006;
continue;
} else {
return true;
...
switch (G__51981) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__51979_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__51979_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__51980_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__51980_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51981)].join('')));
