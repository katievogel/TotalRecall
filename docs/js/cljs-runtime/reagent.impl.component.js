...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41626 = c;
var G__41626__$1 = (((G__41626 == null))?null:G__41626.prototype);
if((G__41626__$1 == null)){
return null;
} else {
return G__41626__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41628 = c;
var G__41628__$1 = (((G__41628 == null))?null:G__41628.prototype);
if((G__41628__$1 == null)){
return null;
} else {
return G__41628__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__41734__delegate = function (args){
...
while (G__41735__i < G__41735__a.length) {G__41735__a[G__41735__i] = arguments[G__41735__i + 0]; ++G__41735__i;}
  args = new cljs.core.IndexedSeq(G__41735__a,0,null);
} 
return G__41734__delegate.call(this,args);};
G__41734.cljs$lang$maxFixedArity = 0;
G__41734.cljs$lang$applyTo = (function (arglist__41736){
var args = cljs.core.seq(arglist__41736);
return G__41734__delegate(args);
});
...
var or__4126__auto__ = (function (){var G__41637 = c;
var G__41637__$1 = (((G__41637 == null))?null:G__41637.constructor);
if((G__41637__$1 == null)){
return null;
} else {
return G__41637__$1.displayName;
}
})();
...
var G__41638 = c;
var G__41638__$1 = (((G__41638 == null))?null:G__41638.constructor);
if((G__41638__$1 == null)){
return null;
} else {
return G__41638__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41642 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41643 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41643);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41642);
}});
...
var c = this;
var G__41653_41741 = goog.object.get(c,"cljsRatom");
if((G__41653_41741 == null)){
} else {
reagent.ratom.dispose_BANG_(G__41653_41741);
}
...
var renders_41743 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_41744 = cljs.core.first(cljs.core.vals(renders_41743));
...
if((cljs.core.count(renders_41743) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41743))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41744)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41744], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41708 = o;
goog.object.set(G__41708,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__41722 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41723 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41723);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41722);
}});
...
var vec__41724 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41724,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41724,(1),null);
...
var G__41727 = goog.object.get(reagent_state,"cljsRatom");
if((G__41727 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__41727);
}
});
}),[]);
